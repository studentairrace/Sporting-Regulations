...
\end{itemize}
    ...
    \begin{enumerate}
      ...
      \item The teams are obliged to provide flight logs that include essential details of the flight, such as the flight route and GPS data, altitude and vertical movement, speed and horizontal motion, flight attitudes and angles, engine performance and control inputs, as well as sensor readings and system status. The flight logs must be submitted in .ulog file format.
