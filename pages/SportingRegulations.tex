...
\end{itemize}
    ...
    \begin{enumerate}
      ...
      The teams are obliged to provide flight logs that include essential details of the flight, as specified below: 
      \item The teams are obliged to provide flight logs that include essential details of the flight, as specified below: 
      \begin{enumerate}
        \item Flight Route and GPS Data:
        The teams must record the precise flight route of their drone and capture GPS data throughout the entire flight.
      
        \item Altitude and Vertical Movement:
        The teams must continuously measure the altitude of the drone and record the vertical movements, including ascending and descending.
      
        \item Speed and Horizontal Motion:
        The teams must measure and record the speed and horizontal motion of the drone.
      
        \item Flight Attitudes and Angles:
        The teams must monitor the flight attitude and angles of the drone as well as document the pitch, roll, and yaw angles.
      
        \item Sensor Readings and System Status:
        The teams must capture important sensor readings, including air pressure, acceleration, and angular velocity.
      \end{enumerate}
      ...
      \item Teams are obliged to record each flight with an onboard camera and provide the organizers with the corresponding video material. The videos must be submitted in either MP4, MOV, or AVI video formats.
    ...
    \subsection{Design Maturity Report}
    \begin{enumerate}
