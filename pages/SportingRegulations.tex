...
\subsection{Objective of the competition}
   \begin{enumerate}
    ...
    \textcolor{red}{The following seems like way too much information. I'd like to see some of those roles filled for profesionalism and as a guide for the teams. However this makes the rules unnesecarily complicated.s
    ...
    The autonomous races will test the ability of the teams to develop and implement autonomous control algorithms for their drones. These races will be held on a separate track and will have their own set of rules.
